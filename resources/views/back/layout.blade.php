  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        @admin
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-pie-chart"></i> <span>@lang('admin.menu.statistics')</span>
    ...
    <ul class="treeview-menu">
        @foreach ($servers as $item)
            <li><a href="{{ $item['route'] }}"><span class="fa fa-fw fa-circle-o text-{{ $item['color'] }}"></span> <span>@lang($item['command'])</span></a></li>
        @endforeach
    </ul>
</li>
